export const products = {
  ...
  "Products created": "Productos creados",
  "All products were created successfully":
    "Todos los productos fueron creados exitosamente",
  "Error creating multiple products": "Error creando múltiples productos",
  "Error creating some products": "Error creando algunos productos",
  "Warehouse Stock": "Stock Bodega",
  "Are you sure you want to upload these products? This will overwrite any existing products with its current STOCK":
    "¿Estás seguro de que quieres cargar estos productos? Esto sobrescribirá cualquier producto existente con su STOCK actual",
  "Quantity (Liter) per unit": "Cantidad (litros) por unidad",
  "Quantity (C.C) per unit": "Cantidad (C.C) por unidad",
  "Quantity (Kilo) per unit": "Cantidad (kilos) por unidad",
  "Quantity (Meter) per unit": "Cantidad (metros) por unidad",
  "Quantity (Centimetre) per unit": "Cantidad (centímetros) por unidad",
  "Quantity (Gram) per unit": "Cantidad (gramos) por unidad",
  Risk: "Riesgo",
